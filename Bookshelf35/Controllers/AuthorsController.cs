...
{
    //add to force authorization for each controller
    [Authorize]
    public class AuthorsController : Controller
    {
        private readonly ApplicationDbContext _context;

        //give controller access to user manager class
        ...
        {
            //get userId to get only their posts
        ...
        {
            //create userId to attatch to requested post
            var user = await GetCurrentUserAsync();
